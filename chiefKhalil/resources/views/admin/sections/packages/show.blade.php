                ...
                <form method="post" action="{{route('packages.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="text" name="name" disabled value="{{$category->name}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Package Price</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" value="{{$category->price}}" type="number" name="price" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Package Duration</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" value="{{$category->duration}}" type="number" name="duration" disabled>
                ...
                <div class="pd-20 card-box mb-30" style="direction: rtl;text-align:right;">
                    ...
                    <form method="post" action="{{route('packages.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" placeholder="Package Name" name="name" disabled value="{{$category->name}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">سعر الباقة</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="Package Price" type="number" name="price" disabled value="{{$category->price}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">مدة الباقة</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="Package Duration" type="number" name="duration" disabled value="{{$category->duration}}">
