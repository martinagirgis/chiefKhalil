    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="section-heading">
                    <h6 class="small-text color-main2">please register now!</h6>
        ...
        <form class="contact-form c-mb-10 c-mb-md-20 c-gutter-20" method="post" action="/">
            <div class="row">
                ...
                <div class="col-12 col-md-3">
                    <div class="form-group has-placeholder">
                        <label for="cooking-class">Example select</label>
                        <select class="form-control" id="cooking-class">
                            <option>Cooking class</option>
                            <option>Baking & Pastry</option>
                            <option>Exotic Cuisines</option>
                            <option>French Desserts</option>
                            <option>Seafood & Wine</option>
                        </select>
                    </div>
                </div>
                <div class="col-sm-12">
            ...
            <div class="row c-mt-10">
                <div class="col-sm-12">
                    <div class="form-group text-center">
                        <button type="submit" id="contact_form_submit" name="contact_submit" class="btn btn-maincolor2">Enroll Now</button>
                    </div>
                </div>
            </div>
        </form>
...
<section class="ls s-py-40 s-py-lg-130 program program-carousel animate" data-animation="fadeInUp"
    id="classes">
    <div class="container">
        <div class="divider-25"></div>
        <div class="row">
            <div class="col-sm-12 text-center">
                <div class="section-heading">
                    <h6 class="small-text color-main2">تابع معنا كل جديد</h6>
                    <h3>أحدث الدورس</h3>
                    <img class="image-wrap" src="images/icon-main.png" alt="">
                </div>
                <div class="d-none d-lg-block divider-60"></div>
                <div dir="rtl" class="carousel-nav row" id="index__courses">
                </div>
            </div>
        </div>
        <div class="divider-30"></div>
...
<section class="ls ms s-pt-lg-100 s-pb-lg-75 c-my-0 video-part right-part-bg text-center text-md-right"
    ...
    <div class="row align-items-center">
        <div class="col-12 col-lg-6 order-lg-1">
            <a href="images/video-image.jpg" class="photoswipe-link"
...
<section class="ls s-py-40 s-py-lg-130 chiefs chiefs-carousel ls animate" data-animation="fadeInUp"
    id="chiefs">
    <div class="container">
        <div class="divider-25"></div>
        <div dir="rtl" class="row">
            <div class="col-sm-12 text-center">
                <div class="section-heading">
                    <!-- <h6 class="small-text color-main">فريق الشيفات</h6> -->
                    <h3>افضل الشيفات</h3>
                    <img class="image-wrap" src="images/icon-main2.png" alt="">
                </div>
                <div class="d-none d-lg-block divider-60"></div>
                ...
                <div class="carousel-nav row">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="vertical-item content-absolute content-hover text-center bordered">
                            <div class="item-media">
                                <img src="images/team/01.jpg" alt="">
                            </div>
                            <div class="item-content bg-maincolor-transparent">
                                <h4>
                                    <a class="dark" href="chief-single.html">الشيف خليل</a>
                                </h4>
                                <!-- <h6 class="small-text">
                                    Master Chef
                                </h6> -->
                                <div class="content-body">
                                    ...
                                    <p class="social-icons">
                                        ...
                                        <a href="#" class="fa fa-google-plus color-light"
                                            title="google"></a>
                                    </p>
                                    <div class="team-button">
                                        <a href="chief-single.html" class="btn btn-team">عرض دوراتة</a>
                                    </div>
                                </div>
                            </div>
                        </div>
