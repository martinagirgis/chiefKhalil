                ...
                <form method="post" action="{{route('packages.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="text" placeholder="Package Name" name="name">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Package Price</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" placeholder="Package Price" type="number" name="price">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Package Duration</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" placeholder="Package Duration" type="number" name="duration">
                ...
                <div class="pd-20 card-box mb-30" style="direction:rtl;text-align:right;">
                    ...
                    <form method="post" action="{{route('packages.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" placeholder="أسم الباقة" name="name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">سعر الباقة</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="سعر الباقة" type="number" name="price">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">مدة الباقة</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="مدة الباقة" type="number" name="duration">
