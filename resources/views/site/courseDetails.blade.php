                ...
                <div class="widget widget_apsc_widget">
                    ...
                    <div class="apsc-icons-wrapper clearfix apsc-theme-4">
                        {{-- <div class="apsc-each-profile">
                            <a class="apsc-instagram-icon clearfix" href="https://www.instagram.com/?url=http://127.0.0.1:8000/en/showCourseDetails/2" target="_blank" rel="noopener">
                        ...
                        {{-- <div class="apsc-each-profile">
                            <a class="apsc-post-icon clearfix" onclick="TWShareLink()">
                                <div class="apsc-inner-block">
                                    <span class="social-icon">
                        ...
                        {{-- <div class="apsc-each-profile">
                            <a class="apsc-facebook-icon clearfix" onclick="FBShareLink()">
                                <div class="apsc-inner-block">
                                    <span class="social-icon">
...
<script>
    ...
    var fburl = "https://www.facebook.com/sharer/sharer.php?u=" + window.location.href;
    window.open(fburl, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');
    }
    //share link in twitter
    function TWShareLink() {
    var twurl = `https://twitter.com/share?url=` + window.location.href + `&text=` + '' + `&hashtags=`+ window.location.hostname;
    window.open(twurl, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');
  }

  function InstaShareLink() {
    var Instaurl = `https://www.instagram.com/?url=` + window.location.href;
    window.open(Instaurl, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');
  }
    </script>
@endsection
