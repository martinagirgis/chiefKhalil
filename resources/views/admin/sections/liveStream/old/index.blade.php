...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/admin/liveStream/main/css/main.css')}}">
    <link rel="stylesheet" href="{{asset('assets/admin/liveStream/css/main.css')}}">
...
<script src="{{asset('assets/admin/liveStream/js/main.js')}}" async></script>
<script src="{{asset('assets/admin/liveStream/main/js/lib/ga.js')}}"></script>
