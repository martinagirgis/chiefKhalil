            ...
            <div class="col-md-12 col-lg-4 animate text-center text-lg-left" data-animation="fadeInUp">
                <div class="widget widget_icons_list footer-list">
                    ...
                    <p class="icon-inline">
                        ...
                        <span>
                            <a class="border-bottom" href="#">support@chefkhalil-school.edu.sa</a>
                        </span>
                    </p>
                    <p class="icon-inline">
                        <span class="icon-styled color-main2">
                        ...
                        <span>
                            <a class="border-bottom" href="#">press@chefkhalil-school.edu.sa</a>
                        </span>
                    </p>
                    ...
                    <p class="icon-inline">
                        ...
                        <span>
                            <a class="border-bottom" href="#">sponsorship@chefkhalil-school.edu.sa</a>
                        </span>
                    </p>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-12 text-center">
                <p> &copy; All Rights reserved to Chef Khalil-School | Developed by We Group Pro 
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-4 animate text-center text-lg-left" data-animation="fadeInUp">
                <div class="widget widget_icons_list footer-list">
                    ...
                    <p style="display: flex;" class="text-right">مدرسة الشيف خليل </p>
                    <p style="display: flex;" class="icon-inline text-right">
                        <span class="icon-styled color-main2">
                            <i class="fa fa-map-marker"></i>
                        </span>
                        <span>السعودية</span>
...
<section class="page_copyright ds s-py-25 s-py-lg-5 s-parallax s-overlay footer-overlay">
    <div class="container">
        <div class="row align-items-center">
            <div class="divider-20 d-none d-lg-block"></div>
            <div class="col-md-12 text-center">
                <p> We Group Pro : جميع حقوق النشر محفوظة لمدرسة الشبف خليل | قام بالتطوير &copy; 
